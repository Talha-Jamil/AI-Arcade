...
function preload(){
  bgImg         = loadImage('/static/images/backg.png');
  birdSprite    = loadImage('/static/images/bird.png');
  pipeBodySprite= loadImage('/static/images/pipebg.png');
  pipePeakSprite= loadImage('/static/images/pipebg.png');
}
