...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const OBSTACLE_MIN_SPACING = 300;
    const OBSTACLE_MAX_SPACING = 600;
    ...
    // Train AI button
    const trainAiButton = document.getElementById("dino-train-ai-button");
    if (trainAiButton) {
